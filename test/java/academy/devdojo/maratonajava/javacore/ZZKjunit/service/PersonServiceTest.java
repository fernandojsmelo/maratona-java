...
class PersonServiceTest {
    ...
    void isAdult_ReturnFalse_WhenAgeIsLowerTha18() {
    ...
    void isAdult_ReturnFalse_WhenAgeIsGreaterOrEqualsTha18() {
    ...
    void filterRemovingNotAdult_ReturnListWithAdultOnly_WhenListOfPersonWithAdultIsPassed() {
        ...
        Assertions.assertEquals(2,
                personService.filterRemovingNotAdult(personList).size());
    }
}